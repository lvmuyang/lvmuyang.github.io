...
<style>
  /* Base dark mode trigger (critical for some browsers) */
  :root {
  ...
  /* DEFAULT (LIGHT MODE) TITLE STYLES - NO INLINE STYLES! */
  .niche-title {
  ...
  /* DARK MODE OVERRIDES (Higher specificity + after default styles) */
  @media (prefers-color-scheme: dark) {
    .research-link {
      color: white !important;
      text-decoration: underline !important;
    }
    /* Dark mode title colors (now override default styles) */
    .niche-title {
    ...
    .extinction-title {
      color: #f08080 !important; /* Light red */
    }
  }
  ...
  /* Shared content container styles (reduced repetition) */
  .research-section {
  ...
  /* Shared image styles (reduced repetition) */
  .research-img {
...
<h2 class="niche-title">Niche modeling</h2>
<div class="research-section">
  <img 
    src="https://lvmuyang.github.io/files/niche_modeling.svg"
    alt="Niche modeling" 
    class="research-img"
    style="float: left !important; margin-right: 2rem !important;">
...
<h2 class="metacomm-title">Meta-community</h2>
<div class="research-section">
  <img 
    src="https://lvmuyang.github.io/files/meta-community.svg"
    alt="Meta-community" 
    class="research-img"
    style="float: right !important; margin-left: 2rem !important;">
...
<h2 class="extinction-title">Extinction risk</h2>
<div class="research-section">
  <img 
